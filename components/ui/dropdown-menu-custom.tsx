...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "focus:bg-accent space-between data-[state=open]:bg-accent flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none",
      inset && "pl-8",
      className,
    )}
    {...props}
  >
    <ChevronLeftIcon className="mr-2 h-4 w-4" /> {/**Changed from default */}
    {children}
  </DropdownMenuPrimitive.SubTrigger>
));
